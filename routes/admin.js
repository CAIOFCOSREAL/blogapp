...
router.post('/postagem/edit', isAdmin, (req, res) => {
    Postagem.findOne({_id: req.body.id}).then((postagem) => {
        if (postagem.titulo == req.body.titulo && postagem.slug == req.body.slug && postagem.descricao == req.body.descricao && postagem.conteudo == req.body.conteudo && postagem.categoria == req.body.categoria) {
            req.flash('error_msg', 'Não houve nenhuma alteração!')
            res.redirect('/admin/postagens')
        }
        else{
